...
Multiple leaflet maps and bar charts (with plotly) were created. These visualisations were then extracted in HTML format and loaded into the HTML dashboard shell as they were being created. Throughout the project, we often reviewedhow we wanted the dashboard to look and restuctured the layout to suit our objectives.
